...
export const metadata: Metadata = {
  title: "KDP Niche Rubric (5-Factor Checklist) | Battlelabs",
  description:
...
export default function KdpNicheScorecardRubricPage() {
  return (
    <main style={pageStyle}>
      <section style={heroStyle}>
        <div style={heroCopyStyle}>
          <p style={eyebrowStyle}>Battlelabs Agent Product Foundry / SKU 002</p>
          <h1 style={titleStyle}>KDP niche rubric (5-factor checklist)</h1>
          <p style={leadStyle}>
            A plain-English scoring rubric for validating a KDP book idea before you spend time building the
        ...
        <aside style={scoreCardStyle} aria-label="Example rubric score">
          <span style={scoreLabelStyle}>Example rubric score</span>
            ...
            <article key={dimension.title} style={dimensionStyle}>
              ...
              <div style={calloutGridStyle}>
                <div style={calloutStrongStyle}>
                  <span style={calloutLabelStyle}>Strong (4–5)</span>
                  <p style={calloutCopyStyle}>{dimension.strong}</p>
                </div>
                <div style={calloutWeakStyle}>
                  <span style={calloutLabelStyle}>Weak (1–2)</span>
      ...
      <section style={splitStyle}>
        <div>
          <p style={eyebrowStyle}>How to use</p>
          <h2 style={sectionTitleStyle}>A simple go/no-go decision loop</h2>
          <p style={sectionCopyStyle}>
            Use the rubric to decide what to do next: narrow the idea, ship a free sample, or publish the
            first paid report template.
          </p>
        </div>
        <ol style={stepsStyle}>
          {steps.map((step) => (
      ...
      <section style={finalCtaStyle}>
        ...
        <h2 style={finalTitleStyle}>Score the niche in 60 seconds</h2>
        <p style={finalCopyStyle}>
          Run the free scorecard, then use the paid template only if the idea is strong enough to test.
          Intro report price {KDP_SCORECARD_OFFER.price}.
        </p>
        <div style={ctaRowStyle}>
          <a href="/kdp-niche-scorecard" style={primaryLinkStyle}>
            Open the scorecard page
          </a>
          <a href="/products/kdp-niche-scorecard/paid-report-template.md" style={secondaryLinkStyle}>
            Preview the report template
          </a>
        </div>
        <p style={microcopyStyle}>No sales or ranking results are guaranteed.</p>
      </section>
    </main>
  );
}
...
const pageStyle: CSSProperties = {
  minHeight: "100vh",
  background: "radial-gradient(circle at top, rgba(255,255,255,0.92) 0%, rgba(245,246,238,0.92) 60%, #ffffff 100%)",
  color: "#173f35",
  fontFamily:
